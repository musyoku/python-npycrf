...
def main():
    ...
    # 学習に用いるテキストデータを準備
    corpus_l = build_corpus(
        args.train_filename_l, args.train_directory_l, supervised=True)
    corpus_u = build_corpus(
        args.train_filename_u, args.train_directory_u, supervised=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="教師データにするテキストファイルのパス")
    parser.add_argument(
        "--train-directory-l",
        "-dir-l",
        type=str,
        default=None,
        help="教師データにするテキストファイルが入っているディレクトリ")
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="教師なしデータにするテキストファイルのパス")
    parser.add_argument(
        "--train-directory-u",
        "-dir-u",
        type=str,
        default=None,
        help="教師なしデータにするテキストファイルが入っているディレクトリ")
