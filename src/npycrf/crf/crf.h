...
namespace npycrf {
	namespace crf {
		...
		public:
			...
			double w_label_u(int y_i) const;
			double w_label_b(int y_i_1, int y_i) const;
			double w_unigram_u(int y_i, int i, int x_i) const;
			double w_unigram_b(int y_i_1, int y_i, int i, int x_i) const;
			double w_bigram_u(int y_i, int i, int x_i_1, int x_i) const;
			double w_bigram_b(int y_i_1, int y_i, int i, int x_i_1, int x_i) const;
			double w_identical_1_u(int y_i, int i) const;
			double w_identical_1_b(int y_i_1, int y_i, int i) const;
			double w_identical_2_u(int y_i, int i) const;
			double w_identical_2_b(int y_i_1, int y_i, int i) const;
			double w_unigram_type_u(int y_i, int type_i) const;
			double w_unigram_type_b(int y_i_1, int y_i, int type_i) const;
			double w_bigram_type_u(int y_i, int type_i_1, int type_i) const;
			double w_bigram_type_b(int y_i_1, int y_i, int type_i_1, int type_i) const;
