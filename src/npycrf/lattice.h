...
namespace npycrf {
	...
	public:
		...
		double _compute_p_z_case_1_1(double*** alpha, double*** beta, double Zs);
		double _compute_p_z_case_1_0(double*** alpha, double*** beta, double Zs);
		double _compute_p_z_case_0_1(double*** alpha, double*** beta, double Zs);
		double _compute_p_z_case_0_0(double*** alpha, double*** beta, double Zs);
