...
namespace npycrf {
	...
	public:
		...
		void _enumerate_marginal_p_path_given_sentence(int sentence_length, double*** pz_s, double** pc_s);
		...
		void _enumerate_proportional_p_substring_given_sentence(int sentence_length, double*** alpha, double*** beta, double** pc_s, double Zs);
