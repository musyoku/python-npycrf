...
namespace npycrf {
	...
	public:
		...
		void _enumerate_marginal_p_path_given_sentence(Sentence* sentence, double*** pz_s, double** pc_s, double Zs);
		double _compute_p_z_case_1_1(Sentence* sentence, int t, double** pc_s, double Zs);
		double _compute_p_z_case_1_0(Sentence* sentence, int t, double** pc_s, double Zs);
		double _compute_p_z_case_0_1(Sentence* sentence, int t, double** pc_s, double Zs);
		double _compute_p_z_case_0_0(Sentence* sentence, int t, double** pc_s, double Zs);
